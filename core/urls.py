...
urlpatterns = [
    ...
    path("applications/<int:pk>/override-eligibility/", api_views.EligibilityOverrideView.as_view(), name="api-eligibility-override"),
    ...
    path("assistant/chat/stream/", api_views.AssistantChatStreamView.as_view(), name="api-assistant-chat-stream"),
